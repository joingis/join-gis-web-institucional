...
function Header({
  ...
  let { logoHovered, setLogoHovered, locale } = useContext(RootLayoutContext)!
  let copy = layoutCopy[locale]
  ...
  return (
    <Container>
      <div className="flex items-center justify-between">
        ...
        >
          <Logomark
            className="h-12 w-24 sm:hidden"
            invert={invert}
            filled={logoHovered}
          />
          <Logo
            className="hidden h-14 w-36 sm:block"
            invert={invert}
            filled={logoHovered}
          />
        </Link>
        <div className="flex items-center gap-x-8">
          ...
          <button
            ...
            aria-label={expanded ? copy.close : copy.menu}
          >
            <Icon
              className={clsx(
                'h-6 w-6',
...
function NavigationItem({
  ...
  let { locale } = useContext(RootLayoutContext)!
...
function Navigation() {
  ...
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/">{copy.home}</NavigationItem>
        <NavigationItem href="/services">{copy.services}</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/about">{copy.about}</NavigationItem>
        <NavigationItem href="/contact">{copy.contactPage}</NavigationItem>
      </NavigationRow>
    </nav>
  )
}
